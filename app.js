...
veryOldInventors = inventors.filter((isOld) => {
  return isOld.year >= 1500 && isOld.year <= 1599;
});
...
// because if the subrtaction will give us negative integer then a is smaller than b an dvice versa. source: MDN docs.
...
idx = comments.findIndex((comments) => {
